...
exports.get = (url, data, headers, timeout = http.timeout) =>
  createRequest("GET", url, data, headers, timeout);

exports.put = (url, data, headers, timeout = http.timeout) =>
  createRequest("PUT", url, data, headers, timeout);

exports.post = (url, data, headers, timeout = http.timeout) =>
  createRequest("POST", url, data, headers, timeout);
